...
public class Controller implements Commons, Initializable {
	...
	private void gameOver() {
		...
		java.io.PrintWriter output = new java.io.PrintWriter(file);
		output.print("Game has ended.");
		output.close();

		inGameOver.set(true);
		labelGameMessage.setText("YOU HAVE NO MORE MONEY LEFT. GAME OVER.");
	...
	private void playerStand() {
		...
		java.io.PrintWriter output = new java.io.PrintWriter(file);
		output.print("Player selects stand.");
		output.close();
	...
	private void playerHit() {
		...
		java.io.PrintWriter output = new java.io.PrintWriter(file);
		output.print("Player selects Hit.");
		output.close();
	...
	private void playerDoubleDown() {
		...
		java.io.PrintWriter output = new java.io.PrintWriter(file);
		output.print("Player has doubled down");
		output.close();
